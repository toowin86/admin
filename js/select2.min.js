...
define('select2/i18n/en',[],function () {
  ...
  return {
    ...
    inputTooLong: function (args) {
      ...
      var message = 'Удалите ' + overChars + ' символ(а)';
    ...
    inputTooShort: function (args) {
      ...
      var message = 'Введите более ' + remainingChars + ' символа';
    ...
    maximumSelected: function (args) {
      var message = 'Вы можите выбрать не более ' + args.maximum + ' значения';
    ...
    searching: function () {
      return '<span class="ico ico_loading"></span> Поиск';
    }
  };
});
